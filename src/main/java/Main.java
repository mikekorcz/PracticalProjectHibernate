...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MovieRepository.saveTittle("Top Gun", "Tony Scott", "Sensacyjny, Romans", 1986, "Tom Cruise, Kelly McGillis, Val Kilmer", "Rewelacyjny film!, Emocjonujące walki w powietrzu.");
